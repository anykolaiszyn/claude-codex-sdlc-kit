...
- CI ([.github/workflows/ci.yml](.github/workflows/ci.yml)) runs all three test suites, the shellcheck command, and the manifest JSON check, on every push to `main` and every PR.
